...
function CadProdutos() {
  ...
  const handleFotosChange = (e) => {
    ...
    setFormData({
      ...formData,
      fotosUrls: value.split(",").map((s) => s.trim()),
    });
  };
  ...
  const handleSubmit = (e) => {
    ...
    if (
      typeof formData.fotosUrls === "string" &&
      formData.fotosUrls.trim().length > 0
    ) {
    ...
    const payload = {
      ...
      teorAlcoolico: formData.teorAlcoolico
        ? parseFloat(formData.teorAlcoolico)
        : null,
      envelhecimento: formData.envelhecimento
        ? parseInt(formData.envelhecimento)
        : null,
    ...
    fetch("http://localhost:8080/produtos/", {
      ...
      .then((res) => {
        if (res.ok) {
          ...
          res
            .text()
            .then((text) => console.error("Erro ao cadastrar produto:", text));
        ...
        <div className={styles.content}>
          ...
          <form onSubmit={handleSubmit} className={styles.formulario}>
            ...
            <input
              ...
              value={
                Array.isArray(formData.fotosUrls)
                  ? formData.fotosUrls.join(", ")
                  : formData.fotosUrls
              }
